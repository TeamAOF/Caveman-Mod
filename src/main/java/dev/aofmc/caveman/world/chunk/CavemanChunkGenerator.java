...
public class CavemanChunkGenerator extends SurfaceChunkGenerator {

    public CavemanChunkGenerator(WorldAccess world, BiomeSource biomeSource, CavemanChunkGeneratorConfig config) {
